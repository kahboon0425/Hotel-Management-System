 ...
 * @author User
 */
public class WaitingListStudent extends javax.swing.JFrame {

    /**
     * Creates new form WaitingListStudnet
     */
    public static int waitingListId;
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Waiting List Form");
    ...
    private void roomCatDropDownMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_roomCatDropDownMenuActionPerformed
        ...
        Object[] roomData = waitingList.readRoomInfo("RoomCategory.txt");
        ...
        startMonthDropDownList.setSelectedIndex(0);
        durationDropDownMenu.setSelectedIndex(0);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        WaitingList.readWaitingListID();
        waitingListId = waitingListId + 1;
        WaitingList.writeWaitingListID();

        System.out.print("WW" + waitingListId);
        String bookingID = "WW" + waitingListId;
        ...
        String allInfomation = (bookingID + "," + currentDate + "," + emailTF + "," + nameTF + "," + phoneTF + "," + studentIDTF + "," + gender + "," + roomCat + "," + startMonth + "," + duration + "," + leavingDateTF + "," + totalFeeTF + "," + "waitingList..." + "," + HostelManagementSystem.loginAsStudent.getName());
        String allDisplayInfomation = (bookingID + "," + currentDate + "," + emailTF + "," + nameTF + "," + phoneTF + "," + studentIDTF + "," + gender + "," + roomCat + "," + startMonth + "," + duration + "," + leavingDateTF + "," + totalFeeTF + "," + "waitingList..." + "," + HostelManagementSystem.loginAsStudent.getName() + "," + "-" + "," + "-");
     
        waitingList.write(allInfomation, "studentWaitingList.txt");
        waitingList.write(allDisplayInfomation, "AllStudentBooking.txt");
        JOptionPane.showMessageDialog(rootPane, "Thank you for submitting your application! You are currently in the waiting list.Once the room is available, you will be notified!");
